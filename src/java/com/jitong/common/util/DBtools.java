   ...
   /* public static Connection getConnection() throws JTException {
    ...
    public static Session getSession() throws JTException {
        try {
           ...
           Thread currentThread=Thread.currentThread();
            System.out.println("currentThread="+currentThread+", hashcode="+currentThread.hashCode());
            System.out.println("session.hashcode="+s.hashCode()+", session="+s);
            return s;
        } catch (HibernateException e) {
    ...
    public static void closeSession() throws JTException {
        try {
            Session s = (Session) tl.get();
            if (null != s) {
            	System.out.println("[closing]session.hashcode="+s.hashCode()+", session="+s);
                s.close();
                tl.set(null);
            }
        } catch (Exception e) {
