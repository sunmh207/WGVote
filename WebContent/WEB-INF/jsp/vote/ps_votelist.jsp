...
<div style="float: left; padding-bottom: 0px;">
	  ...
	  <a class="ui_icon_circle_plus" href="${root}/vote/ps_voteinput!input.do" >新建</a> 
</div>
	 ...
	 <s:iterator value="objectList" status="st">
	 	<s:if test="status == \"1.new\"">
			<tr bgcolor="#FFFF00">
				...
				<td align="center">
					<a class="user-edit" href="${root}/vote/ps_voteinput!input.do?vote.id=<s:property value="id"/>">编辑</a>&nbsp;&nbsp;
					<a class="ui_icon_person" href="${root}/vote/ps_candidate.do?vote.id=<s:property value="id"/>" >候选人</a>&nbsp;&nbsp;
					<a class="statics" href="${root}/vote/ps_vote!ready.do?vote.id=<s:property value="id"/>"  onclick="return fReadyCheck()">准备投票</a>&nbsp;&nbsp;
					<a class="user-delete" href="${root}/vote/ps_vote!delete.do?vote.id=<s:property value="id"/>" onclick="return fDelCheck()">删除</a>&nbsp;&nbsp;
				</td>
			</tr>
		</s:if>
		...
		<tr bgcolor="#00FF00">
			...
			<td align="center">
				...
				<a class="statics" href="${root}/vote/ps_vote!start.do?vote.id=<s:property value="id"/>"  onclick="return fStartCheck()">开始</a>&nbsp;&nbsp;
			</td>
		</tr>
		</s:if>
		...
		<tr bgcolor="#FF0000">
			...
			<td align="center">
				<a class="ui_icon_person" href="${root}/vote/ps_candidate.do?vote.id=<s:property value="id"/>" >候选人</a>&nbsp;&nbsp;
				<a class="ui_icon_person" href="${root}/vote/voter.do?vote.id=<s:property value="id"/>" >投票人</a>&nbsp;&nbsp;
				<a class="statics" href="${root}/vote/ps_vote!stop.do?vote.id=<s:property value="id"/>"  onclick="return fStopCheck()">结束投票</a>&nbsp;&nbsp;
			</td>
		</tr>
		</s:if>
